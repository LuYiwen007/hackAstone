...
import type { TimePeriodMeta } from "../../shared/api/arena";
...
function describePeriod(period: TimePeriodMeta) {
  if (period.showAll) {
    return "显示全部时代的哲学家";
  }
...
export function Home() {
  ...
  const currentPeriod =
    timePeriods.find((period) => period.id === selectedPeriodId) ?? timePeriods[0];
      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
        ...
        <section className="mb-12 rounded-xl border border-zinc-800 bg-zinc-900 p-6">
          ...
          <input
            ...
            value={Math.max(
              0,
              timePeriods.findIndex((period) => period.id === selectedPeriodId)
            )}
            onChange={(event) => {
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <div className="font-bold text-sm md:text-base">{region.name}</div>
